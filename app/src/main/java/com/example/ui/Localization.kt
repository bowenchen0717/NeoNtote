...
object Localization {
    private val translations = mapOf(
        ...
        "settings_version_title" to Pair("版本資訊與更新檢測", "Version Info & Updates"),
        "settings_current_version" to Pair("目前安裝版本", "Installed Version"),
        "settings_check_update_btn" to Pair("檢查最新版本與更新", "Check for Updates"),
        "settings_checking_update" to Pair("正在連線 Google Play 檢測...", "Checking Google Play..."),
        "settings_already_latest" to Pair("已是最新版本 (%s)", "You are on the latest version (%s)"),
        "settings_go_to_playstore" to Pair("開啟 Google Play 商店頁面", "Open Google Play Store"),
        "settings_legal_title" to Pair("法律條款與隱私權", "Legal & Policies"),
        "settings_privacy_policy" to Pair("應用程式隱私權政策", "Privacy Policy"),
        "settings_terms_of_service" to Pair("應用程式服務條款", "Terms of Service"),
